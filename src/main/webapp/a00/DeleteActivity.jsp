    ...
    <div class="contact-form section-gap">
      <div class="wrapper">
        <div class="contact-form" style="max-width: 450px; margin: 0 auto;">
          <div class="form-mid">
            <form action="${pageContext.request.contextPath}/DeleteActivity" method="post" enctype="multipart/form-data">
       		 <h2>Delete Data</h2>
              <div class="field">
              ...
              <input name="activityContent" class="form-control" value="${aBean.activityContent}" placeholder="活動內容"
                required=""></textarea>
              <div class="field">
