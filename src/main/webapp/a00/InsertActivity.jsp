    ...
    <div class="contact-form section-gap">
      <div class="wrapper">
        <div class="contact-form" style="max-width: 450px; margin: 0 auto;">
          <div class="form-mid">
            <form action="${pageContext.request.contextPath}/InsertActivity" method="post" enctype="multipart/form-data">
       		 <h2>Insert Data</h2>
       		 	${message}
              <div class="field">
                <input type="text" class="form-control" name="activityId" value="${aBean.activityId}" placeholder="活動名稱" required >
              </div>
              <div class="field">
