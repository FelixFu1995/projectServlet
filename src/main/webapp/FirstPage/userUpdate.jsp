             ...
             <thead>
		        <tr>
                 ...
                 <tr>
                    <th>會員編號</th>
                   <td>
                    <input type="hidden" name="userId" value="<%= request.getAttribute("userId") %>" /><%= request.getAttribute("userId") %>
                </td>
                <tr>
                    <th>帳號</th>
                   <td>
                    <input type="hidden" name="userAccount" value="<%= request.getAttribute("userAccount") %>" /><%= request.getAttribute("userAccount") %>
                </td>
                </tr>
                <tr>
                    <th>姓名</th>
                ...
                <tr>
                    <th>性別</th>
                    <td>
                     <input type="hidden" name="userGender" value="<%= request.getAttribute("userGender") %>" /><%= request.getAttribute("userGender") %>
                    </td>
                ...
                <tr>
                    <th>出生日期</th>
                    <td>
                    	<input type="date" name="userBirthDay" value="<%= request.getAttribute("userBirthDay") %>" />
                    </td>
                </tr>
                <tr>
                    <th>地址</th>
                    <td>
                    <input type="text" name="userAddress" value="<%= request.getAttribute("userAddress") %>" />
                    </td>
                </tr>
                <tr>
                    <th>電話</th>
                    <td>
                    <input type="text" name="userTel" value="<%= request.getAttribute("userTel") %>" />
                    </td>
                </tr>
                <tr>
                    <th>信箱</th>
                    <td>
                    <input type="text" name="userEmail" value="<%= request.getAttribute("userEmail") %>" />
                    </td>
                ...
                <tr>
                    <th>暱名</th>
                    <td>
                    <input type="text" name="userNickName" value="<%= request.getAttribute("userNickName") %>" />
                    </td>
