ㄧ <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page import="javax.servlet.http.HttpSession" %>
        ...
        <body>
            <% boolean userLoggedIn=false; if (session.getAttribute("userLoggedIn") !=null) { userLoggedIn=(Boolean)
                session.getAttribute("userLoggedIn"); } %>
                <div class="container-fluid">
                    <header>
                        <nav class="navbar navbar-expand-lg bg-body-tertiary">
                            <div class="container-fluid">
                                <a class="navbar-brand" href="FirstPage.jsp"><i class="fa fas fa-solid fa-dumbbell"></i> Oh
                                    GymGym</a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    ...
                                    <% if (userLoggedIn) { %>
                                        <a class="navbtn" id="userAreaLink" href="UserArea.jsp">
                                            <img src="../images/user__icon_new.png" alt="Custom Icon" height="30px"
                                                width="30px">
                                        </a>
                                        <% } else { %>
                                            <a class="navbtn" id="userAreaLink" href="../Member/Login.jsp">
                                             <span class="Login">我要登入</span>
                                            </a>
                                            <a class="navbtn" id="userAreaLink" href="${pageContext.request.contextPath}/Member/FitnessRsgister.html">
											...
											<% if (session.getAttribute("userAccount") !=null) { %>
                                                <a class="navbtn" href="./cart.html"><img src="../images/cart_new.jpg"
                                                        alt="Custom Icon" height="30px" width="30px"></a>
                                                <a class="navbtn" href="#" data-toggle="modal"
                                                    data-target="#exampleModal3"><img src="../images/message_new.png"
                                                        alt="Custom Icon" height="30px" width="30px"></a>
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="2000">
                                <img src="../images/gym11.avif" class="d-block w-100" alt="..." />
                            </div>
                            <div class="carousel-item" data-bs-interval="2500">
                                <img src="../images/gym22.avif" class="d-block w-100" alt="..." />
                            </div>
                            <div class="carousel-item" data-bs-interval="3000">
                                <img src="../images/gym33.avif" class="d-block w-100" alt="..." />
                            </div>
                        </div>
              ...
              ">
                                    <img src="../images/44.avif" alt=""
                                        style="margin-top: 30px; max-width: 100%; max-height: 100%" href="#" />
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div style="
