...
<head>
    ...
    <link rel="icon"
        ...
        type="image/x-icon" />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/plugins/OneItemList.css?ver=1 23" />
...
<body>
    ...
    <div class="wholePageContent">
        ...
        <c:forEach items="${OneComList}" var="com">
         <font color="red">${msg}<br><br></font>
            ...
            <img src="data:image/png;base64,${com.comPicBase64}" height="100px" width="100px" name="comPicBase64"/>
            <input type="hidden" name="comId" value="${com.comId}">
                ...
                <div class="add-input">
                    ...
                    <input type="text" name="comNumber" id="comNum" required pattern="[0-9]+" value="${com.comNumber }">
                </div>
                <div class="add-input">
                ...
                <div class="add-input">
                    <label for="comPic" class="comPic">商品圖片:
                    <input type="file" style="display:none"  name="comPic" id="comPic" onchange="previewImage(this)">
                    <img
							src="data:image/png;base64,${com.comPicBase64}" name="comPica"
							height="100px" width="100px"  class="comPica"/>
							 </label>
                </div>
                <div class="preview">
                    <img id="previewImg">
    ...
    <script>
        ...
        function previewImage(input) {
            ...
            document.querySelector('.comPica').style.display = 'none';
        }
