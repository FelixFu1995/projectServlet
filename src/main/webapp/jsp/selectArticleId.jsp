	...
	<div align="center">
		...
		<table border="1">
			...
			<tr>
				...
				<form action="${pageContext.request.contextPath}/updateArticle" method="post" enctype="multipart/form-data">
				<%
					ArticleBean articleBean2 = (ArticleBean) request.getAttribute("articleBean");
					%>
				<input type="hidden" value="<%=articleBean.getArticleId()%>" name="articleId">	
				<input type="hidden" value="<%=articleBean.getArticleTitle()%>" name="articleTitle">
				<input type="hidden" value="<%=articleBean.getArticleContent()%>" name="articleContent">
				<input type="hidden" value="<%=articleBean.getArticleTime()%>" name="articleTime">
				<input type="hidden" value="<%=articleBean.getArticleType()%>" name="articleType">
				...
				<form action="${pageContext.request.contextPath}/deleteArticle" method="post" onsubmit="return confirm('確定要刪除這篇文章嗎？')">
						<button class="button1" type="submit" name="articleId"
